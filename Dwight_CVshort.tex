...
\begin{minipage}[t]{0.4\textwidth}
  \begin{flushright}
    \Title{}\\\FullCV\\ \homepage{\Profile} %\Website{\PersonalWebsite}
  \end{flushright}
\end{minipage}
\\[0.1cm]
...
\begin{EntriesTableDuration}
  ...
  \\
  \Duration{2022}{2022}  &
  \textbf{Facilitator}, \MLFRJ.% Supervisor: David Kang.
  \\
  \Duration{2020}{2021}  &
...
% \Year{2024}  &
%  \textbf{Defective parking functions and Young tableaux} (in progress).
%   \newline
%   \PEH; \GradCollab{\Alex}; \GradCollab{\Aaron}; \GradCollab{\Lauren}; \UGCollab{\Cynthia}; \Me. 
%  \\
\Year{2024}  &
  \textbf{Symplectic differential reduction algebras and skew-affine generalized Weyl algebras} (submitted).
  \newline
  \arXivAbs{2403.15968}. \Publication{10.3842/SIGMA.2025.001}{SIGMA}, \arXivAbs{2403.15968}. 
  \newline
  \Jonas; \Me. 
 \\
\Year{2023}  & 
...
% \Year{2024} &
% \textbf{Humanizing proof-based mathematics instruction through experiences reading rich proofs and mathematician stories} (in progress).
% \newline
% \GradCOllab{\Norman}; \Paul; \GradCollab{\Lino}; \GradCollab{\Norman}; \PEH; \Kristen; \Katel; \KyeongHah; \Me; \Aris.  
% \\
\Year{2024} &
\textbf{Opposing
...
%   \Sarah; \Michael; \Carl; \Aris; \GradCollab{\Maya}; \Me; \GradCollab{\Christian}; \Simone; \Miriam; \PEH.
  \end{EntriesTableYear}
    ...
    \vspace{-0.3cm}
    \begin{EntriesTableDuration}
March 2024 & "Reduction (Super)algebras", Algebra Seminar (online), \UWM \\
March 2024 & "Lie superalgebras, representation theory, and mathematical physics", Colloquium (online), \MSU\\
February 2024 & "Laplace's equation, Dirac's equation, and algebraic methods", AMS UTA Seminar (online), \UTA\\
November 2023 & "Extremal Equations \& Algebraic Methods", Early Career Math Colloquium (online)
\end{EntriesTableDuration}
...
\vspace{0.1in}
    ...
    \vspace{-0.3cm}
    \begin{EntriesTableDuration}
\Duration{2024}{\Ongoing} & Twymun Safford, Angeluis Sayavongsa-Vaughn. \MSU. \textit{MANIM+MATH+MENTORING}.\\
...
\Duration{2022}{2023} & Andrew Shannon, \Pomona. Senior Thesis: The Diffie-Hellman Problem in Lie Algebras Revisited.\\
...
Membership &
 ...
 %American Mathematical Society, Mathematical Association of America, National Association of Mathematicians.
  \\
Mentor     &
 POWER (Black Male Initiative). 
  \\
Organizer  &
 \href{https://\Profile.com/FRACTALS}{Active learning seminars},
 %\href{https://\Profile.com/FRACTALS}{Fresh Researchers in Algebra, Combinatorics, and Topology Active Learning Seminar},
