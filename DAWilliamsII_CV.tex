...
% To emphasize pre-baccalaureate, pre-doctoral status (added by Dwight)
...
\vspace{0.1in}
Co-author names: \small{\textbf{pre-baccalaureate}/\textit{pre-doctoral}} by date of submission
...
\Year{2023}  & 
  ...
  \arXiv{2311.14055}.  
  \newline
  \GradCollab{\Tomas}; \Jennifer; \Rebecca; \GradCollab{\KimberlyP}; \PEH; \GradCollab{\Kimberly}; \GradCollab{\Imhotep}; \GradCollab{\Jakeyl}; \GradCollab{\Jan}; \GradCollab{\Kobe}; \Carlos; \GradCollab{\Cas}; \GradCollab{\DanielTwo}; \GradCollab{\Dirk}
